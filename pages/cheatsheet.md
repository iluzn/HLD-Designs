...
| 30 | [Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | DFS: `1 + max(left, right)` | O(n) | O(h) |
...
| # | Problem | Approach | Time | Space |
|---|---|---|---|---|
| 35 | [Number of Islands](https://leetcode.com/problems/number-of-islands/) | BFS/DFS from each '1', mark visited | O(m×n) | O(m×n) |
